...
class TherapistController extends Controller
{
    ...
    $sessionDone = $totalSchedule - $sessionLeft;
        ...
        return view('dashboard/dashboard-therapist', compact('therapistInfo', 'totalChild', 'totalSchedule', 'sessionLeft', 'reportSubmitted', 'sessionDone', 'therapistName'));
    }
    ...
    public function therapistSessionDetails($date, $time)
    {
        ...
        return view('sessionDetails-therapist', compact('schedules', 'date', 'time', 'therapistName'));
    }
    ...
    return view('stdDetails-therapist', compact('childInfo', 'therapistName'));
    }
    public function therapistStdReportList()
    {
        ...
        return view('stdReportList-therapist', compact('schedules', 'therapistName'));
