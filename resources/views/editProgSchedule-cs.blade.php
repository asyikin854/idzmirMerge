...
<div class="container-fluid calendar-basic">
        ...
        <div class="card-body">
            <div class="row" id="wrap">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tr>
                            <th>New Program Details <br>{{$package->package_name}} | {{$package->package_step}} </th>
                            <td><ol>
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <p><strong>Program Session Quantity:</strong> {{ $package->session_quantity }}</p>
            <div class="table-responsive">
            <table class="table table-bordered">
                <thead>
                    <tr>
            ...
            <!-- Hidden form inputs -->
            <form action="{{ route('editProgSchedule-cs', ['child_id' => $child_id, 'package_id' => $package->id]) }}" method="POST" onsubmit="return confirmSubmit()">
                @csrf
                ...
                <br>
                <a href="{{route('stdDetails-cs', ['id'=> $child_id])}}"><button type="button" class="btn btn-danger mt-3">Cancel</button></a>&nbsp;<button type="submit" class="btn btn-primary mt-3">Confirm</button>
            </form>
        </div>
    </div>
