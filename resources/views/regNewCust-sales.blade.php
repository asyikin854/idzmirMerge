...
#requiredFieldsList li {
    margin-bottom: 5px;
    font-size: 12px;
    color: #555;
}

#requiredFieldsList li.missing {
    color: red;
    font-weight: 500;
}
</style>
...
@section('script')
<script src="{{ asset('assets/js/form-wizard/form-wizard-two2.js') }}"></script>
