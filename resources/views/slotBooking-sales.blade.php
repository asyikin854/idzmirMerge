...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">Slot Booking</li>
@endsection
...
<div class="container-fluid calendar-basic">
    ...
    <div class="card mt-4">
        <div class="card-body">
            <h5>Selected Slots Summary (Assessment)</h5>
            ...
            <!-- Hidden form inputs -->
            <form action="{{ route('submitBooking-sales', ['child_id' => $child_id, 'package_id' => $package->id]) }}" method="POST" onsubmit="return confirmSubmit()">
                @csrf
