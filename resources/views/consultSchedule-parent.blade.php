...
<div class="container-fluid calendar-basic">
                    ...
                    <div class="md-sidebar mb-3">
                        ...
                        <div class="md-sidebar-aside job-left-aside custom-scrollbar">
                            <div id="external-events">
                                <h4>Consultation Schedule Selection</h4>
                                <span>You need to select only ONE slot for consultation</span>
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <!-- Hidden form inputs -->
            <form action="{{ route('consultSchedule.submit', ['child_id' => $child_id, 'package_id' => $package->id]) }}" method="POST" onsubmit="return confirmSubmit()">
                @csrf
