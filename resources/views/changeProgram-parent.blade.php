...
<div class="container-fluid product-wrapper">
  <div class="row">
    <div class="card">
      <div class="mb-6">
      <h5>Your current program is </h5>
      {{$package->package_step}} |
      {{$package->package_name}} |
      No. of Sessions: {{$package->session_quantity}}
    </div>
  </div>
  </div>
                           ...
                           <div class="product-qnty">
                             <div class="addcart-btn">
                               <a class="btn btn-danger" data-bs-dismiss="modal" aria-label="Close">Close</a>
                                 <a href="{{route('newSchedule-parent', ['child_id'=>$childInfo->id, 'package_id'=>$package->id])}}"><button class="btn btn-primary ms-2" type="submit">Proceed</button></a>
                             </div>
                           </div>
                         </div>
                       </div>
