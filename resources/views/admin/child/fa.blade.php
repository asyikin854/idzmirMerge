...
@section('breadcrumb-title')
    <h3>Full Assesment</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Analytics</li>
    <li class="breadcrumb-item active">Full Assesment</li>
@endsection
...
<div class="container-fluid">
   <div class="row">
        ...
        <div class="col-sm-12 col-xl-6">
            <form action="{{ route('admin.child.fa') }}" method="GET" class="form-inline">
            ...
            <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Session 4:</strong> {{ $totalChildrenPackage2Active }}</p>
                        <p><strong>Session 8:</strong> {{ $totalChildrenPackage12Active }}</p>
                        <p><strong>Student Full Assessment:</strong> {{ $TotalActiveChild212 }}</p>
