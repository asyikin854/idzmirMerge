...
<div class="container-fluid">
   <div class="row">
        ...
        <div class="col-sm-12 col-xl-6">
            <form action="{{ route('admin.child.rts') }}" method="GET" class="form-inline">
            ...
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header bg-warning">               
                                ...
                                <h5>PROGRAM READY TO SCHOOL WITH ASSESSMENT BY STUDENT</h5>
                    </div>
                    <div class="card-body">
        
                                            <p><strong>Session 4 :</strong> {{ $totalChildrenPackage6Active }}</p>
                                <p><strong>Session 8 :</strong> {{ $totalChildrenPackage7Active }}</p>
                                <p><strong>Student RTS:</strong> {{ $TotalActiveChild67 }}</p>
                                <p> <strong> Performance :{{ $PerformanceActiveStudent }} </strong> %</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="card">
                        <div class="card-header bg-info">               
                                    ...
                                    <h5>ACTIVE PROGRAM RTS CAPACITY PER HOUR</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                                                ...
                                                <p><strong>Total inactive session  :</strong> {{$totalInactiveStudentByAttendance}}</p>
                                    <p><strong>Total inactive students
                                        :</strong> {{$totalInactiveStudentByStatus}}</p>
                                    
                                    <p> <strong>Performance Lost Risk by session
                                        : </strong> {{ $PerformanceLostRiskBySession}} %</p>
                                        <p> <strong>Performance Lost Risk by Students

                                            : </strong> {{ $PerformanceLostRiskByStudent}} % </p>
