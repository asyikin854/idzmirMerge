<div class="page-header">
  <div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper col-auto p-0">
      <div class="logo-wrapper"><a href="{{ route('sales.dashboard')}}"><img class="img-fluid" src="{{ asset('assets/images/logo/logo1.png') }}" alt=""></a></div>
      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown pe-0 py-0">
          <div class="media profile-media"><img class="b-r-10" src="{{ asset('assets/images/dashboard/profile.png') }}" alt="">
            <div class="media-body"><span>{{$salesName}}</span>
              <p class="mb-0 font-roboto">Customer Service<i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
