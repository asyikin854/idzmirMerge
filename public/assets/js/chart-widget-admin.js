(function ($) {
  ...
  $.ajax({
    url: "/get-monthly-data", // Laravel route
    method: "GET",
    success: function (response) {

      /* Line chart 1: Monthly Sales */
      var optionslinechart1 = {
        chart: { toolbar: { show: false }, height: 200, type: "area" },
        dataLabels: { enabled: false },
        stroke: { width: 3, curve: "smooth" },
        xaxis: { type: "datetime", categories: response.months },
        yaxis: { labels: { show: true } },
        grid: { show: true },
        fill: { opacity: 0.2 },
        colors: ["#1E90FF"],
        series: [{ name: "Monthly Sales", data: response.salesData }],
        tooltip: { x: { format: "MMM yyyy" } },
    };

    var chartlinechart1 = new ApexCharts(
        document.querySelector("#chart-widget1"),
        optionslinechart1
    );
    chartlinechart1.render();

      /* Line chart 2: New Student Registrations */
      var optionslinechart2 = {
        chart: { toolbar: { show: false }, height: 200, type: "area" },
        dataLabels: { enabled: false },
        stroke: { width: 3, curve: "smooth" },
        xaxis: { type: "datetime", categories: response.allTimeMonths },
        yaxis: { labels: { show: true } },
        grid: { show: true },
        fill: { opacity: 0.2 },
        colors: ["#FF6347"],
        series: [{ name: "New Students", data: response.studentData }],
        tooltip: { x: { format: "MMM yyyy" } },
    };
    ...
    chartlinechart2.render();
      ...
      var optionslinechart3 = {
        ...
        fill: { opacity: 0.2 },
        colors: ["#32CD32"],
        series: [{ name: "All-Time Sales", data: response.allTimeSalesData }],
        tooltip: { x: { format: "MMM yyyy" } },
    };
  ...
  // column chart
  $.ajax({
    url: "/get-program-data", // Adjust endpoint to match your route
    method: "GET",
    success: function (response) {
        // Create column chart for packages
        var optionscolumnchart = {
            series: [
                {
                    name: "Number of Student",
                    data: response.seriesData, // Use data from backend
                },
            ],
            chart: {
                type: "bar",
            ...
            xaxis: {
                categories: response.categories, // Package names
                floating: false,
                axisTicks: {
                    show: false,
                },
            ...
            colors: ["#51bb25"], // Adjust color if needed
            fill: {
                type: "gradient",
                gradient: {
                    shade: "light",
    ...
    error: function (err) {
        console.error("Error fetching package chart data:", err);
    },
});
